...
|-----------|------------------------|
| Резервирование ресурсов | Дополнительные сервера с не полной нагруженностью |
...
| Резервирование ElasticSearch | Репликация шардов (1 primary + 1 replica per shard). Реплики автоматически берут на себя роль primary при сбое |
| Резервирование L3/L4 | Аппаратное (N+1). Keepalived + LVS (Virtual Server via Direct Routing). При отказе балансировщика автоматически активируется резервный |
