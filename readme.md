...
label.spotify.com - домен для загрузки треков лейблами.
recomendations.spotify.com - домен для рекомендательной системы.

## Обоснование расположения ДЦ
Известно, что основными пользователями Spotify являются жители Европы. 
Поэтому в Европе датацентры будут находиться во Франкфурте-на-Майне в Германии, в Амстердаме в Нидерландах.
В США датацентры будут в Сан-Франциско, как один из крупнейших городов западного побережья, и Нью-Йорке.
В Южной Америке в Аргентине и Бразилии.
